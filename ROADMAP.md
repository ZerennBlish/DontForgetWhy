...
### Source of Truth · Updated: Session 44 (May 7, 2026) — v2.0.2 doc close-out
...
| | |
|---|---|
| **Current Version** | **v2.0.2 (versionCode 46)** — welcome overlay with guided slides + Opening.mp3, blur routing fix, games count corrected to 7. |
| **Branch** | `dev` and `main` in sync at v2.0.2. |
| **Production Status** | v2.0.2 (versionCode 46) AAB built. v2.0.1 (versionCode 45) is current Play Store baseline. |
| **Current Focus** | Doc close-out, Firebase modular migration, Play Store updates. |
| **Blocked By** | Nothing |
| **Next Action** | Upload v2.0.2 to Play Store, Firebase modular migration, screenshot refresh. |
| **EAS Credits** | ~16 remaining (1 production build this session — v2.0.1 branding refresh). Reset May 12. |
...
- **Dice game** — new game, not scoped yet.
