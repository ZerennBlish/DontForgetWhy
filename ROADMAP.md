...
### Source of Truth · Updated: Session 47 (May 16, 2026) — v2.1.0 prep close-out
...
| **Production Status** | v2.0.2 (versionCode 46) shipped to Play Store on May 13, 2026. v2.1.0 (versionCode 47) ready on dev+main, AAB not yet built. |
| **Current Focus** | Session 47 close-out, then weekly maintenance in a fresh chat. |
| **Blocked By** | Nothing. |
| **Next Action** | Build v2.1.0 production AAB and upload to Play Store. Schedule voice clip recording session for Alarm Guy character lines (10 new lines drafted Session 47). |
...
| May 13 | v2.0.2 shipped to Play Store, including the That One Dice Game work from Session 46 (Yahtzee-style, 13 categories, 7-second steal window, 2–4 players with any mix of human and CPU, multiplayer via Firestore, dual dice themes — toon dice free, chrome dice Pro). |
