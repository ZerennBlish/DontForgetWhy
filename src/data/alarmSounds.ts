...
export const ALARM_SOUNDS: AlarmSound[] = [
  ...
  { id: 'silent', label: 'Vibrate Only', icon: '\u{1F4F3}', channelId: 'alarms_silent_v5', description: 'Vibration only, no sound' },
  { id: 'true_silent', label: 'Silent', icon: '\u{1F507}', channelId: 'alarms_true_silent_v2', description: 'No sound, no vibration' },
];
